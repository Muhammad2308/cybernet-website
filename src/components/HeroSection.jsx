...
export const HeroSection = ({ onOpenPortal }) => {
  return (
    <section className="relative overflow-hidden bg-cyber-light dark:bg-cyber-dark text-slate-900 dark:text-white py-20 md:py-32 px-4 sm:px-6 lg:px-8 transition-colors duration-300">
      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12 relative z-10">
        ...
        <div className="w-full lg:w-1/2 text-center lg:text-left space-y-6">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-cyber-purple/10 dark:bg-cyber-purple/30 border border-cyber-purple/30 text-cyber-purple dark:text-cyber-purple-light text-xs sm:text-sm font-semibold">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start pt-4">
            <a 
              href="#solutions" 
              className="px-6 py-3.5 rounded-xl bg-gradient-to-r from-cyber-purple to-cyber-purple-glow text-white font-semibold flex items-center justify-center gap-2 shadow-glow-purple hover:opacity-95 transition-all"
            >
              Explore Platforms <ArrowRight className="w-4 h-4"/>
            </a>
            <a 
              href="#contact" 
              className="px-6 py-3.5 rounded-xl border border-slate-300 dark:border-cyber-border bg-white dark:bg-cyber-card text-slate-800 dark:text-slate-200 font-semibold flex items-center justify-center gap-2 hover:bg-slate-50 dark:hover:bg-cyber-card/80 transition-all"
            >
              <Activity className="w-4 h-4 text-cyber-bronze-light"/> Request Consultation
            </a>
          </div>

          <div className="pt-6 grid grid-cols-3 gap-4 border-t border-slate-200 dark:border-cyber-border/60 max-w-md mx-auto lg:mx-0">
            <div>
        ...
        <div className="w-full lg:w-1/2 flex justify-center">
          <div className="relative p-4 rounded-3xl bg-gradient-to-b from-cyber-border/40 to-transparent border border-cyber-border/50 backdrop-blur-md shadow-2xl max-w-sm sm:max-w-md group">
